...
// @remove-on-eject-end
const chunkNamesPlugin = require('@fea/chunk-names-webpack-plugin');

const publicPath = require('./devConfig').publicPath;
...
const getOutput = entryConfig => {
  ...
  return {
    mainFilename,
    filename(chunkData) {
      return chunkData.chunk.name === name ? mainFilename : `static/${scope}/js/[name].js`;
    },
          ...
          use: [
            {
              options: {
                ...
                baseConfig: {
                  extends: [require.resolve('@fea/eslint-config-fea-app')],
