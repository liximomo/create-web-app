...
const entryResolver = require('@fea/webpack-entry-resolver');
const parseArgs = require('minimist');
const createWebpackConfig = require('../config/webpack.config.prod');
const argv = parseArgs(process.argv.slice(2));
let entryFiles = entryResolver(argv, { srcRoot: paths.appSrc });
if (entryFiles === null) {
  entryFiles = [
    {
      name: 'main',
      entryPath: paths.appIndexJs,
      htmlTemplatePath: paths.appHtml,
    },
  ];
}
